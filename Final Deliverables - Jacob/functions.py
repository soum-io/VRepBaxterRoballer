...
# =============================================================================
    ...
    if numberBlocks == 4:
        ...
        c3start = np.array([[1,0,0,xstart],
                      [0,1,0,ystart],
                      [0,0,1,table+ 3*height + (height/2)+pad],
                      [0,0,0,1]])
    
        moveObj(c0start, clientID, block0)
        moveObj(c1start, clientID, block1)
        moveObj(c2start, clientID, block2)
        moveObj(c3start, clientID, block3)
        ...
        getLeftToPoint(False, xstart, ystart, top, midTravel)
        getLeftToPoint(False, xstart, ystart, fourth, slowTravel)
        LeftCup(True)
        getLeftToPoint(False, xstart, ystart, top, midTravel)
        ...
        getLeftToPoint(False, xend, yend, top, midTravel)
        getLeftToPoint(False, xend, yend, second, slowTravel)
        LeftCup(False)
        getLeftToPoint(False, xend, yend, top, midTravel)
        ...
        getLeftToPoint(False, xmiddle, ymiddle, top, midTravel)
        getLeftToPoint(False, xmiddle, ymiddle, third, slowTravel)
        LeftCup(False)
        getLeftToPoint(False, xmiddle, ymiddle, top, midTravel)
        ...
        getLeftToPoint(False, xend, yend, top, midTravel)
        getLeftToPoint(False, xend, yend, fourth, slowTravel)
        LeftCup(False)
        getLeftToPoint(False, xend, yend, top, midTravel)
        ...
        getLeftToPoint(False, xend, yend, 1.5, fastTravel)
        getLeftToPoint(False, xend, yend, 2, fastTravel)
