...
thetaLeft = np.array([[0], [math.radians(0)], [math.radians(0)], [math.radians(-2)], [math.radians(0)], [math.radians(0)], [math.radians(0)], [math.radians(0)]])
...
#right arm
thetaRight= np.array([[0], [math.radians(0)], [math.radians(-20)], [math.radians(0)], [math.radians(0)], [math.radians(0)], [math.radians(0)], [math.radians(0)]])
MR = np.array([[1,0,0,64],
              [0,1,0,-1435.94],
              [0,0,1,1295.35],
              [0,0,0,1]])
...
a6 = np.array([[-1],[0],[0]])
q6 = np.array([[64],[-1085.64],[1295.35]])
bottom6 = np.dot(-skew(a6),q6)
S6 = np.zeros((6,1))
S6[:3] = np.copy(a6)
S6[3:] = np.copy(bottom6)
...
a7 = np.array([[0],[-1],[0]])
q7 = np.array([[64],[-1085.64],[1295.35]])
bottom7 = np.dot(-skew(a7),q7)
S7 = np.zeros((6,1))
S7[:3] = np.copy(a7)
S7[3:] = np.copy(bottom7)
...
vrep.simxSetJointTargetPosition(clientID, leftArm[0], math.radians(0), vrep.simx_opmode_oneshot)
...
for i in range(1,7):
    ...
    vrep.simxSetJointTargetPosition(clientID, leftArm[i], math.radians(0), vrep.simx_opmode_oneshot)
vrep.simxSetJointTargetPosition(clientID, leftArm[2], math.radians(-2), vrep.simx_opmode_oneshot)
